...
// `closure` 內沒有 statement，照理說是回傳 `Void`，但函式宣告又分別宣告了回傳值是
// `String` 和 `Double`，因此會報錯而不會有 return type
...
func greet1(person name: String) -> String {
  return "Hello, \(name)"
}
greet1(person: "Dave")
...
//:-----------------------------------------------------------------------------
//:## Q4
//:Please declare a function named `greet` with `person` as an **argument label** and `name` as a **parameter name**. This `greet` function will return a `String`. For example, you call the function `greet` like this:
/*:```
greet(person: "Luke")
```*/
